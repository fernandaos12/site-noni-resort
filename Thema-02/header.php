							...
							<div class="radio">
								<div class="row">
									...
									<div class="small-12 large-4 medium-4 columns">
										<a href="http://noniresort.com.br/">
											<img src="<?php echo get_bloginfo('template_directory');?>/library/images/logo-radio-cafe-la-music.jpg" alt="Rádio Café La Music" />
										</a>
									</div>
								  	...
								  	<div class="small-12 large-8 medium-8 columns">
								  		<div class="small-6 large-6 medium-6 columns">
										  	<div class="pl">
										  		<?php echo do_shortcode('[sc_embed_player_template1 fileurl="http://noniresort.com.br/downloads/dezembro/12_12_2015.mp3" autoplay="no" loops="true"]'); ?>									  		
									  		</div>
									  	</div>

									  	<div class="small-6 large-6 medium-6 columns">
										  	<div class="pl">									  		
										  		<a href="http://noniresort.com.br/?p=46">
										  			<img src="<?php echo get_bloginfo('template_directory');?>/library/images/download_icon.png" alt="Download Playlist" />
										  		</a>
								  			</div>
									  	</div>								  		
							  		</div>
