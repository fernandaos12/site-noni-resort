...
<?php get_header(); ?>
			...
			<div class="lateral">
				<div class="logo"><a href="<?php echo home_url(); ?>"><img src="<?php echo get_bloginfo('template_directory');?>/library/images/logos-cafe-02bg.png" alt="None Resort Home" /></a>
				</div>
			...
			<div id="content">
				...
				<div id="inner-content" class="row">			
				    ...
				    <p>e receba informações exclusivas em primeira mão.</p></h3>
						...
						<?php echo do_shortcode('[contact-form-7 id="57" title="Formulario-Cafe-la-musique-cumbuco"]') ?>
