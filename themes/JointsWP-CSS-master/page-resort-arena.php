...
<?php get_header(); ?>
			<div class="lateral">
			<div class="logo"><a href="<?php echo home_url(); ?>"><img src="<?php echo get_bloginfo('template_directory');?>/library/images/logos-noni-arena-bg.png" alt="None Resort Home" /></a>	</div>
			</div>
			...
			<div id="content">
				...
				<div id="inner-content" class="row">
				    ...
				    <div class="large-12 medium-12 small-12 columns" role="main">
						...
						<?php echo do_shortcode('[contact-form-7 id="24" title="Formulario-NONI-RESORT-ARENA"]') ?>
